      ...
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <div className="flex flex-col w-5/6 mx-auto">
          ...
          <input
            ...
            className="text-[10px] py-2.5 border-b-2 border-[#918EF4] focus:border-indigo-500 transition-colors bg-transparent placeholder-gray-400 outline-none"
        ...
        <div className="flex justify-center mt-8 mb-10">
          <button
            type="submit"
            disabled={loading}
            className={`bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full text-white font-semibold px-12 py-3 text-sm tracking-wide uppercase transition-all duration-300 
